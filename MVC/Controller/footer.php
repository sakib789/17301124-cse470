    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-12">
                <h4 class="font-rubik font-size-20">Knot Creation</h4>
...
<div class="copyright text-center bg-dark text-white py-2">
    <p class="font-rale font-size-14">&copy; Copyrights 2020. Desing By <a href="https://www.linkedin.com/in/md-nazmur-sakib/" class="color-second">Nazmur Sakib</a></p>
</div>
<!-- !start #footer -->
